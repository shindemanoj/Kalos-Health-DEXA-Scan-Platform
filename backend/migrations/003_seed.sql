...
-- The password hashes in this file are placeholders and will NOT match any real password.
-- Use the JS seeder instead, which generates real bcrypt hashes at runtime:
--
--   node scripts/seed.js
--   (or: npm run seed)
--
-- The JS seeder also safely re-runs without creating duplicates.
